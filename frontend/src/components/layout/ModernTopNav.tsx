...
import {
  Search, Bell, HelpCircle, Menu, Flame, Star, ChevronDown, Check, UserRound, Shield, LogOut
} from 'lucide-react';
    ...
    <header className="sticky top-0 z-30 h-16 bg-white/95 backdrop-blur-md border-b border-slate-200/80 px-4 sm:px-8 flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-3 sm:gap-4 flex-1 max-w-xl">
        <button
          ...
          className="lg:hidden w-10 h-10 rounded-2xl bg-slate-100 hover:bg-slate-200 flex items-center justify-center text-slate-700 transition-colors"
        ...
        <div className="relative w-full max-w-md">
          ...
          />
          <kbd className="hidden sm:inline-block absolute right-3 top-1/2 -translate-y-1/2 bg-white border border-slate-200 px-1.5 py-0.5 rounded text-[10px] font-mono text-slate-400 shadow-2xs">
            ⌘K
          </kbd>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="px-3 py-1.5 rounded-2xl bg-blue-50 hover:bg-blue-100/80 border border-blue-200 text-blue-700 text-xs font-bold flex items-center gap-1.5 transition-colors"
          >
        ...
        <div className="relative">
          <button
            ...
            className="w-10 h-10 rounded-2xl bg-slate-100/80 hover:bg-slate-200/80 text-slate-600 hover:text-slate-900 flex items-center justify-center transition-colors relative"
            title="Notifications"
          >
          ...
          {showNotifMenu && (
            <div className="absolute right-0 mt-2 w-80 bg-white rounded-2xl shadow-xl border border-slate-200 p-3 z-50 animate-fadeIn">
              ...
              <div className="space-y-2">
                {notifications.map(n => (
                  <div key={n.id} className="p-2 rounded-xl bg-slate-50 hover:bg-blue-50/50 transition-colors text-xs">
        ...
        <button
          ...
          className="hidden sm:flex w-10 h-10 rounded-2xl bg-slate-100/80 hover:bg-slate-200/80 text-slate-600 hover:text-slate-900 items-center justify-center transition-colors"
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 p-1 pl-1.5 rounded-2xl hover:bg-slate-100 transition-colors"
          >
            <img
