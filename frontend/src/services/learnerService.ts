...
export const initialCalendarEvents: CalendarEventItem[] = [
  {
    id: 'evt-past-01',
    title: 'Orientation & Learning Path Setup',
    type: 'live_session',
    date: '2026-09-04',
    time: '10:00 AM – 11:30 AM',
    duration: '90 mins',
    courseName: 'Platform Onboarding',
    trainerName: 'Dr. Arun Verma',
    status: 'completed',
    meetingUrl: 'https://meet.skillsync.edu/live-orientation',
    description: 'Foundational orientation detailing cohort objectives, diagnostic benchmarks, and rubric guidelines.',
  },
  {
    id: 'evt-past-02',
    title: 'Diagnostic Benchmark: Full Stack Web Architecture',
    ...
    status: 'completed',
    description: 'Timed diagnostic assessment benchmarking RESTful endpoints, relational databases, and auth guards.',
  },
  {
    id: 'evt-past-03',
    title: 'Live Workshop: React State Management & Hooks',
    type: 'workshop',
    date: '2026-09-14',
    ...
    status: 'completed',
    meetingUrl: 'https://meet.skillsync.edu/live-react-hooks',
    description: 'Practical code walkthrough on context API patterns, custom hooks, and React Query caching.',
  },
  {
    id: 'evt-today-01',
    title: 'Live Lab: Container Orchestration & Docker Telemetry',
    type: 'live_session',
    date: '2026-09-17',
    ...
    status: 'upcoming',
    meetingUrl: 'https://meet.skillsync.edu/live-docker-telemetry',
    description: 'Hands-on session configuring Prometheus metrics, cluster ingress, and pod health checks.',
  },
  {
    id: 'evt-01',
